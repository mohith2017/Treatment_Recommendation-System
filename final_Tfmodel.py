...
# X=X.convert_to_tensor(y_pred, dtype=tf.float64)
y = data.loc[:, data.columns == 'treatment']
# y=y.convert_to_tensor(y_pred, dtype=tf.float64)
...
# X_test=X_test.convert_to_tensor(y_pred, dtype=tf.float64)
print(X_test)
y_pred = logreg.predict(X_test)
